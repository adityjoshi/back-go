...
//     try {
//       const headers = GetAuthHeader();
//       const body = { name, description, room, complaintType }; // Include complaintType in the request body
//       const response = await fetch("http://localhost:2426/complaints", {
//         method: "POST",
//         headers: headers,
//         body: JSON.stringify(body),
...
//   // Categorize complaints into specific columns
//   const categorizedComplaints = {
//     ...groupedComplaints,
//     Others: complaints.filter(complaint => !groupedComplaints[complaint.complaint_issues]),
//   };

//   console.log(categorizedComplaints);
...
//           {Object.entries(categorizedComplaints).map(([type, complaintsOfType]) => (
